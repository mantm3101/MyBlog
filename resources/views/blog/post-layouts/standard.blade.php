...
@include('blog.partials.header-post', ['image' => $post->post_image, 'title' => $post->title, 'subtitle' => $post->subtitle, 'meta' => trans('larablog.blogroll.postedBy', ['author' => $post->author, 'url' => url('/author/' . $post->author), 'date' => format_normal_date($post->published_at)]) ])
